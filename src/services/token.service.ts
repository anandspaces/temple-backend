...
export async function signToken(payload: SignTokenPayload): Promise<SignTokenResult> {
...
export async function verifyToken(token: string): Promise<VerifyTokenResult | null> {
  const secret = env.JWT_SECRET;
